...
export function attachTouchControls(canvas, input) {
    ...
    joy.addEventListener('pointermove', (e) => { if (e.pointerId === joyActiveId)
        updateJoy(e); });
    ...
    function bindHold(el, key) {
        const onDown = (e) => { input.keys.add(key); el.setPointerCapture?.(e.pointerId); e.preventDefault(); };
...
function mkButton(label, color, pos, small = false) {
